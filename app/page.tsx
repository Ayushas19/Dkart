    ...
    <main>
      ...
      <div className="marquee-container" aria-hidden="true">
        <div className="marquee-content">
          • SAMASTIPUR HYPERLOCAL MARKETPLACE • DELIVERED FAST • EXCLUSIVE LOCAL DROPS • SHOP SAMASTIPUR • SAME DAY DROP • SUPPORT LOCAL VENDORS • SAMASTIPUR HYPERLOCAL MARKETPLACE • DELIVERED FAST • EXCLUSIVE LOCAL DROPS • SHOP SAMASTIPUR • SAME DAY DROP • SUPPORT LOCAL VENDORS •
        </div>
      </div>
      ...
      <div className="page page-home active">
        ...
        {/* 5. Brand Ethos Story (Scroll-Linked Parallax Mask Reveal) */}
        <AboutBrand />
