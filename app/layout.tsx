...
// Required: Next.js 14.2 + next-auth SessionProvider requires dynamic rendering.
// Without this, SSG attempts to render SessionProvider server-side, crashing on useState.
